...
| S-06 | Review center | — | Superseded — removed | [review-center.md](review-center.md) |
...
| S-09 | Autonomy settings | — | Superseded — removed | [engine-configuration.md](engine-configuration.md#autonomy-settings) |
...
- ~~[Review Center](review-center.md)~~ — Superseded, removed
- [Knowledge Base](knowledge-base.md) - Managing hotel knowledge and site scraper
- [Engine Configuration](engine-configuration.md) - Apps and automation rules
