...
export class MockPMSAdapter implements PMSAdapter {
  ...
  constructor(_config: MockPMSConfig, _context: PluginContext) {
...
export function createMockPMSAdapter(
  config: MockPMSConfig,
  context: PluginContext
): MockPMSAdapter {
  return new MockPMSAdapter(config, context);
}
...
export const manifest: PMSAppManifest = {
  ...
  icon: '🧪',
  docsUrl: 'https://github.com/jackthebutler/jack/tree/main/packages/pms-mock',
  configSchema: [
    {
  ...
  createAdapter: (config, context) => createMockPMSAdapter(config as unknown as MockPMSConfig, context),
};
