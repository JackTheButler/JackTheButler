 ...
 * Ollama Provider
 *
 * Local LLM support via Ollama for the integrations layer.
 * This wraps the core Ollama provider with connection testing.
 */
...
const log = createLogger('integrations:ai:ollama');
 ...
 */
export class OllamaProvider implements LLMProvider, BaseProvider {
  readonly id = 'ollama';
