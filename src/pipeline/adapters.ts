/**
 * Provider adapters binding @thebutler/pipeline's contracts to Butler:
 * service-backed providers (conversation, knowledge, memory, prompts,
 * intent, entity) plus the registry-dependent `aiProvider`, which resolves
 * the hotel's active AI provider per call via the app registry.
 *
